...
export default class WorldCylinder {
  ...
  updateRingPosition(playerPosition: any) {
    const { ring } = this;
  ...
  */
  updateMainCylindersTiling(playerPosition: any) {
    const { c1, c2 } = this;
