...
export default class GameMapChunk {
  ...
  isRoot!: boolean;
  instances!: any[];
  defaultPositions!: Record<string, any>;
  defaultStates!: Record<string, any>;
  states!: Record<string, any>;
  offsetY!: number;
  onBeforeLoad!: (chunk: GameMapChunk) => void;
  ...
  getInstance(offsetY: any) {
    let chunk: GameMapChunk | undefined;
    if (this.isRoot) {
